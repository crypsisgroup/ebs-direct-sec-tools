#!/bin/bash
echo Building
BIN_FILE=$(echo $1.bin|sed 's/.go/_amd64/g'|sed 's/\///g'|sed 's/\.//g')
WIN_FILE=$(echo $1.exe|sed 's/.go/_amd64/g'|sed 's/\///g'|sed 's/\.//g')
MAC_FILE=$(echo $1.bin|sed 's/.go/_amd64_mac/g'|sed 's/\///g'|sed 's/\.//g')
